...
public class BottomlessPitNetherGenerator extends NoiseChunkGenerator {
    ...
    public static final Codec<BottomlessPitNetherGenerator> CODEC = RecordCodecBuilder.create((instance) -> {
    ...
    public BottomlessPitNetherGenerator(BiomeSource biomeSource, RegistryEntry<ChunkGeneratorSettings> settings) {
