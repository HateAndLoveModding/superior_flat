...
import static net.fabricmc.fabric.impl.biome.TheEndBiomeData.biomeRegistry;
...
public class SoulSandValleyNetherGenerator extends NoiseChunkGenerator {
    ...
    public static final Codec<SoulSandValleyNetherGenerator> CODEC = RecordCodecBuilder.create((instance) -> {
    ...
    public SoulSandValleyNetherGenerator(BiomeSource biomeSource, RegistryEntry<ChunkGeneratorSettings> settings) {
