...
public class TunnelersDreamNetherGenerator extends NoiseChunkGenerator {
    ...
    public static final Codec<TunnelersDreamNetherGenerator> CODEC = RecordCodecBuilder.create((instance) -> {
    ...
    public TunnelersDreamNetherGenerator(BiomeSource biomeSource, RegistryEntry<ChunkGeneratorSettings> settings) {
